...
**PESTO** (Parameter ESTimation Optimised) is an R package
that provides high-performance parameter estimation, uncertainty
quantification, and inverse modelling capabilities. It builds on the
modernised PEST++ algorithms developed by the USGS, bringing these
powerful tools natively into the R ecosystem.
