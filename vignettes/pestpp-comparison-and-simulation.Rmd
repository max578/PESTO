...
correctly defers to the full forward model. The favourable regime —
where the same machinery saves a substantial fraction of evaluations —
is the standalone surrogate demo earlier in the vignette, and it is
